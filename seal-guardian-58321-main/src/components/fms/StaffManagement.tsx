    ...
    return (
        <div className="space-y-8 max-w-7xl mx-auto">
            <Tabs defaultValue="current" className="w-full">
                <div className="flex flex-col lg:flex-row justify-between items-center gap-6 mb-8 sticky top-0 md:top-5 z-30 bg-white/95 backdrop-blur-md py-4 md:py-6 px-4 md:px-2 -mx-4 md:-mx-2 rounded-2xl md:rounded-3xl border-b md:border border-orange-100 shadow-sm">
