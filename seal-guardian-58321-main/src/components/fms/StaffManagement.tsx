    ...
    return (
        <div className="space-y-8 max-w-7xl mx-auto">
            <Tabs defaultValue="current" className="w-full">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-8 sticky top-5 z-30 bg-white py-4 px-2 -mx-2 rounded-3xl border border-orange-100 shadow-[0_8px_30px_rgba(0,0,0,0.02)]">
                    <TabsList className="bg-white p-1 rounded-full h-11 w-full md:w-auto grid grid-cols-2 md:inline-flex gap-0.5 shadow-sm border border-orange-100">
                        <TabsTrigger value="current" className="relative z-10 rounded-full px-8 py-2 text-sm font-bold text-slate-500 data-[state=active]:text-orange-600 data-[state=active]:bg-orange-50/50 data-[state=active]:shadow-sm transition-all duration-500 ease-out whitespace-nowrap">
                            <Users className="h-4 w-4 mr-2" /> Current Team ({manpowerList?.length || 0})
                        </TabsTrigger>
                        <TabsTrigger value="past" className="relative z-10 rounded-full px-8 py-2 text-sm font-bold text-slate-500 data-[state=active]:text-orange-600 data-[state=active]:bg-orange-50/50 data-[state=active]:shadow-sm transition-all duration-500 ease-out whitespace-nowrap">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                                        <div className="md:col-span-3 space-y-2">
                                            ...
                                            <Input
                                                ...
                                                className="rounded-xl h-12 border-slate-100 bg-slate-50/50 focus:bg-white focus:border-orange-200 focus:ring-4 focus:ring-orange-500/10 transition-all font-bold text-slate-700"
                                                required
                                            />
                                        </div>
                                        <div className="md:col-span-3 space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <Input
                                                    ...
                                                    className="pl-11 rounded-xl h-12 border-slate-100 bg-slate-50/50 focus:bg-white focus:border-orange-200 focus:ring-4 focus:ring-orange-500/10 transition-all font-bold text-slate-700 font-mono"
                                                    required
                                                />
                                            </div>
                                        </div>
                                        <div className="md:col-span-2 space-y-2">
                                            ...
                                            <div className="relative">
                                                <Input
                                                    value={newMember.id}
                                                    readOnly
                                                    className="rounded-xl h-12 border-slate-100 bg-slate-100/50 text-slate-500 font-black text-center tracking-wider"
                                                />
                                            </div>
                                        </div>
                                        <div className="md:col-span-2 space-y-2">
                                            ...
                                            <select
                                                ...
                                                className="flex h-12 w-full rounded-xl border border-slate-100 bg-slate-50/50 px-3 py-2 text-sm font-bold text-slate-700 focus:bg-white focus:outline-none focus:border-orange-200 focus:ring-4 focus:ring-orange-500/10 transition-all cursor-pointer hover:bg-white"
                                            >
                                        ...
                                        <div className="md:col-span-2">
                                            <Button
                                                type="submit"
                                                className="w-full h-12 rounded-xl bg-orange-500 hover:bg-orange-600 font-bold uppercase tracking-widest shadow-lg shadow-orange-500/20 active:scale-95 transition-all text-[10px]"
                                                disabled={isAdding}
                                            >
                                        ...
                                        <div className="flex flex-col h-full">
                                            <div className="p-6 flex-1">
                                                <div className="flex justify-between items-start mb-6">
                                                    <div className="h-14 w-14 rounded-2xl bg-orange-50 border border-orange-100 flex items-center justify-center text-orange-600 font-black text-xl shadow-inner relative">
                                                ...
                                                <div className="space-y-4 mb-6">
                                                    <div>
                                                        <h3 className="text-xl font-bold text-slate-800 group-hover:text-orange-600 transition-colors">{toTitleCase(member.name)}</h3>
                                                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">ID: {member.manpower_id}</p>
                                                    </div>
                                                    <div className="space-y-2">
                                                        <div className="flex items-center gap-3 text-sm text-slate-600 font-bold">
                                                            <Phone className="h-4 w-4 text-slate-400" /> {member.phone_number}
                                                        </div>
                                                        <div className="flex items-center gap-3 text-sm text-slate-600 font-bold">
                                                            <Briefcase className="h-4 w-4 text-slate-400" /> {member.applicator_type === 'seat_cover' ? 'Seat Cover Expert' : 'PPF Specialist'}
                                                        </div>
                                                    </div>
                                                </div>

                                                <div className="grid grid-cols-3 gap-3 border-t border-slate-100 pt-6">
                                                    <button onClick={() => onShowWarranties(member, 'validated')} className="flex flex-col items-center p-2 rounded-xl bg-green-50 hover:bg-green-100 transition-colors border border-green-100">
                                                        <span className="text-lg font-black text-green-600">{member.validated_count || 0}</span>
                                                        <span className="text-[9px] font-black text-green-700/50 uppercase tracking-widest">Approved</span>
                                                    </button>
                                                    <button onClick={() => onShowWarranties(member, 'pending')} className="flex flex-col items-center p-2 rounded-xl bg-amber-50 hover:bg-amber-100 transition-colors border border-amber-100">
                                                        <span className="text-lg font-black text-amber-600">{member.pending_count || 0}</span>
                                                        <span className="text-[9px] font-black text-amber-700/50 uppercase tracking-widest">Pending</span>
                                                    </button>
                                                    <button onClick={() => onShowWarranties(member, 'rejected')} className="flex flex-col items-center p-2 rounded-xl bg-red-50 hover:bg-red-100 transition-colors border border-red-100">
                                                        <span className="text-lg font-black text-red-600">{member.rejected_count || 0}</span>
                                                        <span className="text-[9px] font-black text-red-700/50 uppercase tracking-widest">Rejected</span>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        {editingId === member.id ? (
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                                                <div className="col-span-3 flex items-center gap-4">
                                                    <div className="h-12 w-12 shrink-0 rounded-xl bg-orange-50 border border-orange-100 flex items-center justify-center text-orange-600 font-black text-lg">
                                                        {(member.name || '').substring(0, 2).toUpperCase()}
                                                    </div>
                                                    <div>
                                                        <h4 className="font-bold text-slate-800 group-hover:text-orange-600 transition-colors">{toTitleCase(member.name)}</h4>
                                                        <p className="text-[10px] font-bold text-slate-400 uppercase">{member.manpower_id}</p>
                                                    </div>
                                                </div>
                                                <div className="col-span-2 text-sm font-bold text-slate-500 flex items-center gap-2">
                                                    <Phone className="h-3.5 w-3.5 text-slate-400" /> {member.phone_number}
                                                </div>
                                                <div className="col-span-2">
                                                    <Badge variant="secondary" className="bg-orange-50 text-orange-600 border-none font-bold text-[10px] uppercase tracking-wider px-3 py-1">
                                                        {member.applicator_type === 'seat_cover' ? 'Seat Cover' : 'PPF'}
                                                    </Badge>
                                                </div>
                                                <div className="col-span-3 flex justify-center gap-2">
                                                    <button onClick={() => onShowWarranties(member, 'validated')} className="px-3 py-1.5 rounded-lg bg-green-50 hover:bg-green-100 border border-green-100 flex items-center gap-2 transition-colors">
                                                        <span className="text-xs font-black text-green-600">{member.validated_count || 0}</span>
                                                        <span className="text-[9px] font-bold text-green-700/50 uppercase">Appr.</span>
                                                    </button>
                                                    <button onClick={() => onShowWarranties(member, 'pending')} className="px-3 py-1.5 rounded-lg bg-amber-50 hover:bg-amber-100 border border-amber-100 flex items-center gap-2 transition-colors">
                                                        <span className="text-xs font-black text-amber-600">{member.pending_count || 0}</span>
                                                        <span className="text-[9px] font-bold text-amber-700/50 uppercase">Pend.</span>
                                                    </button>
                                                </div>
                                                <div className="col-span-2 flex justify-end items-center gap-2">
                                                    <Button variant="ghost" size="icon" onClick={() => handleEditClick(member)} className="h-10 w-10 rounded-xl text-slate-400 hover:bg-orange-50 hover:text-orange-600">
                                                        <Edit2 className="h-4 w-4" />
                                                    </Button>
                                                    <Button variant="ghost" size="icon" onClick={() => onDelete(member.id)} className="h-10 w-10 rounded-xl text-slate-400 hover:bg-red-50 hover:text-red-600">
                        ...
                        <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                            {filteredPast.map((member) => (
                                <Card key={member.id} className="bg-slate-50 border-orange-50 opacity-75 hover:opacity-100 transition-all duration-300 overflow-hidden group hover:bg-white hover:shadow-lg ">
                                    <div className="p-8">
                                        <div className="flex justify-between items-start mb-6">
                                            <div className="h-12 w-12 rounded-xl bg-slate-100 border flex items-center justify-center text-slate-400 font-black text-lg">
                                                {(member.name || '').substring(0, 1).toLowerCase()}
                                            </div>
                                            <Badge variant="outline" className="text-[10px] font-black uppercase tracking-widest bg-slate-100 border-slate-200 px-3 py-1 rounded-full text-slate-500">Inactive</Badge>
                                        </div>
                                        <h3 className="font-black text-2xl text-slate-700 tracking-tight mb-1">{toTitleCase(member.name)}</h3>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <button
                                                ...
                                                className="flex flex-col items-center p-4 rounded-2xl bg-white border border-slate-100 hover:bg-orange-50 hover:border-orange-100 transition-all group/btn shadow-sm"
                                            >
                                                <span className="text-xl font-black text-slate-800 group-hover/btn:text-orange-600 transition-colors">{member.validated_count || 0}</span>
                                                <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 mt-1">Approved</span>
                                            </button>
                                            ...
                                            {member.removed_reason && (
                                                <div className="col-span-1 p-3 rounded-2xl border border-dashed border-slate-200 flex items-center justify-center text-center bg-slate-50">
                                                    <p className="text-[9px] font-bold text-slate-400 italic leading-tight">Reason:<br />{member.removed_reason}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                <Card key={member.id} className="group border-orange-50 opacity-75 hover:opacity-100 transition-all duration-300 overflow-hidden bg-white/60 hover:bg-white hover:shadow-md relative">
                                    <div className="p-4 md:p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
                                        <div className="flex items-center gap-4">
                                            <div className="h-12 w-12 rounded-xl bg-slate-100 border flex items-center justify-center text-slate-400 font-black text-lg shrink-0">
                                                {(member.name || '').substring(0, 1).toLowerCase()}
                                            </div>
                                            <div>
                                                <h4 className="text-lg font-black text-slate-700 tracking-tight">{toTitleCase(member.name)}</h4>
                                        ...
                                        <div className="flex items-center gap-6">
                                            <div className="flex flex-col items-center px-4 py-2 rounded-xl bg-slate-50 border border-slate-100">
                                                <span className="text-sm font-black text-slate-700">{member.validated_count || 0}</span>
                                                <span className="text-[8px] font-black uppercase tracking-widest text-slate-400">Approved</span>
                                            </div>
                                            {member.removed_reason && (
                                                <div className="px-4 py-2 rounded-xl border border-dashed border-slate-200 bg-slate-50/50 max-w-[200px]">
                                                    <p className="text-[9px] font-bold text-slate-400 italic leading-tight text-center">Reason: {member.removed_reason}</p>
                                                </div>
                                            )}
                                            <Badge variant="outline" className="text-[9px] font-black uppercase tracking-widest bg-slate-100 border-slate-200 text-slate-400 h-fit px-3">Inactive Member</Badge>
                                        </div>
                                    </div>
                                </Card>
                            ))}
