    ...
    return (
        <div className="animate-in fade-in duration-700">
            ...
            >
                ...
                <div className="flex flex-col lg:flex-row gap-6 items-center justify-between mb-8 sticky top-0 lg:top-5 z-40 bg-white/95 backdrop-blur-md py-4 md:py-6 px-4 md:px-2 -mx-4 md:-mx-2 rounded-2xl md:rounded-3xl border-b md:border border-orange-100 shadow-sm transition-all duration-300">
