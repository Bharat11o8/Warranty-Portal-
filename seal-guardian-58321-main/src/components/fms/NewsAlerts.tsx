...
import { Calendar, ChevronRight, Info, Megaphone, Search, Filter, ShieldCheck, AlertTriangle } from "lucide-react";
...
export const NewsAlerts = () => {
    ...
    // Base filter: only show alert/system types (admin broadcasts)
    ...
    const getIcon = (type: string) => {
        switch (type) {
            ...
            default: return <ShieldCheck className="h-6 w-6 text-blue-600" />;
        }
    };
    ...
    const getColors = (type: string) => {
        switch (type) {
            ...
            default: return { border: "border-blue-500/20", bg: "bg-blue-500/10", text: "text-blue-600", bar: "bg-blue-500" };
        }
    };
