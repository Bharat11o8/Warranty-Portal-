 ...
 *
 * Usage:
 *   tsx scripts/tools/bulk_map_franchises.ts <file.csv>            # dry run
 *   tsx scripts/tools/bulk_map_franchises.ts <file.csv> --apply    # write
 *
...
async function main() {
    if (!csvPath) {
        console.error('Usage: tsx scripts/tools/bulk_map_franchises.ts <file.csv> [--apply]');
        process.exit(1);
    }
