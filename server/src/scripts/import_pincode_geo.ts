...
import { placeAllPincodes, distanceKm, type Office, type PincodeCentre } from '../services/pincodeCentre.js';
import { parseCoordinate, isTestAccount } from '../services/storeLocator.js';
 ...
 *
 * Run:  npx tsx src/scripts/import_pincode_geo.ts <path-to-json> [--dry]
 */
...
async function main(): Promise<void> {
    ...
    if (!file || !fs.existsSync(file)) {
        console.error('Usage: npx tsx src/scripts/import_pincode_geo.ts <path-to-json> [--dry]');
        process.exit(1);
    }
